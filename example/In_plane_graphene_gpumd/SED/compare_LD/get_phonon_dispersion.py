...
def get_band_path(band_path, band_label, band_resolution=2001):
...
def phonon_calculator(relaxed_atoms, calculator, repeat_cell,
    ...
    phonon = get_force_constants(relaxed_atoms, calculator, [repeat_cell, repeat_cell, 1])
    ...
    # Get band path
    bands, bands_and_labels = get_band_path(band_path, band_label)
...
def get_calculator(structure, NEP_file, band_path, band_label, if_use_D3=False, repeat_cell=8):
...
if __name__ == "__main__":
    ...
    band_label = [('Gamma', 'M'), ('M', 'K'), ('K', 'Gamma')]
