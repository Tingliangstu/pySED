'''
@author:
********************  Made some modifications by LiangTing  ************************
******************* Most of the code comes from phonolammps ************************
                      liangting.zj@gmail.com
************************ 2020/8/28 14:22:15 *******************
This seem like getting the atomic index of atom_unit_cell_index
'''
...
def get_correct_arrangement(reference, structure, supercell_matrix):
    ...
    for coordinate in reference:
        trans = np.dot(coordinate, np.linalg.inv(structure.get_cell()))  # Get inverse matrix
    ...
    for coordinate in unit_cell_scaled_coordinates:
        # Only works for non symmetric cell (Need to improve)
